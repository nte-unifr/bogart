...
#        if( (count($session_data) >= 2) && ($session_data[1] !== $user) && ($session_data[0] > $now->format('Y-m-d H:i:s')) ){
        if( $lock ){
            ...
            $formMapper
                ...
                ->end()
                ->with($noms_onglet . 'Croissance / floraison', array(), array('attr' => array('style' => 'max-width: 300px;', 'class' => 'titi')))
                    ->add('nomFr')
                    ->add('nomDe')
        ...
        #            ->add('floraison')
                ...
                ->end()
                ->with('Origine / Menacé', array('collapsed' => true))
                    ...
                    ->add('cites')
                ->end()
                ->with('Médic. / Utile / Tox.', array('collapsed' => true))
                    ->add('planteMed')
                    ->add('planteMedInfo')
                    ->add('planteUtile')
                    ->add('planteUtileInfo')
