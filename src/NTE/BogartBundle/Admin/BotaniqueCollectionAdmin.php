...
#        return array_merge($accession->getFieldNames(), $accession->getAssociationNames());
        return array_merge($accession->getFieldNames(), $accession->getAssociationNames(), array('idTaxon.famille2', 'idTaxon.origines', 'idTaxon.origine1', 'idTaxon.origine2', 'idTaxon.origine3', 'idTaxon.origine4', 'idTaxon.origine5', 'idTaxon.origineAutre', 'idTaxon.croissance_noms'));
    }
