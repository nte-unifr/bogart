...
class BotaniqueCroissanceAdmin extends Admin
{
    /**
     * @return array
     */
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ->addIdentifier('nom')
            ->add('fichier', 'sonata_type_model', array('template' => 'NTEBogartBundle:Croissance:crudimage.html.twig'))
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ->add('nom')
            ->add('fichier', 'sonata_type_model', array('required' => false), array('link_parameters' => array('context' => 'default', 'provider'=>'sonata.media.provider.image')))
            ->end()
        ;
    }
