 ...
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="BotaniqueAccessionRepository");
 */
...
#        return $this->provenance;
        return (string)($this->provenanceType . " / " . $this->idPays . ", " . $this->location . ", " . $this->altitude . " " . $this->altitudeM);
    }
