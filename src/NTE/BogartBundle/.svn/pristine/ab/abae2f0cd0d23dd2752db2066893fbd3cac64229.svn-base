...
use NTE\BogartBundle\Entity\BotaniqueEndroit;
 
class BotaniqueEndroitAdmin extends Admin
{
    /**
     * @return array
     */
    ...
    {
        $accession = $this->container->get('doctrine.orm.entity_manager')->getClassMetadata('NTE\BogartBundle\Entity\BotaniqueEndroit');
