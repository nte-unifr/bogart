...
use NTE\BogartBundle\Entity\BotaniqueFamille;
 
class BotaniqueFamilleAdmin extends Admin
{
    /**
     * @return array
     */
    ...
    {
        $accession = $this->container->get('doctrine.orm.entity_manager')->getClassMetadata('NTE\BogartBundle\Entity\BotaniqueFamille');
