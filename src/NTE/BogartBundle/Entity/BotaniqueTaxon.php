...
class BotaniqueTaxon
{
     ...
     * @var string
     *
     * @ORM\Column(name="habitat_fr", type="text", nullable=true)
     */
    private $habitatFr;
     ...
     * @var string
     *
     * @ORM\Column(name="habitat_de", type="text", nullable=true)
     */
    private $habitatDe;
     ...
     * @var string
     *
     * @ORM\Column(name="remarque_fr", type="text", nullable=true)
     */
    private $remarqueFr;
     ...
     * @var string
     *
     * @ORM\Column(name="remarque_de", type="text", nullable=true)
     */
    private $remarqueDe;
     ...
     * @var string
     *
     * @ORM\Column(name="origines", type="string", length=255, nullable=true)
     */
    private $origines;
     ...
     * @var string
     *
     * @ORM\Column(name="croissance_noms", type="string", length=255, nullable=true)
     */
    private $croissance_noms;

    /**
     * @ORM\ManyToMany(targetEntity="BotaniqueCategorie", inversedBy="taxons")
    ...
    public function getCroissancesAsString()
	{
        $result = "";
        foreach ($this->croissance as $croissance) {
            $result == "" ? $separateur = "" : $separateur = ", ";
            $result .= $separateur . $croissance;
        }
	    return $result;
	}
    ...
    {
        // pour éviter d'avoir des espaces qui se succèdent dans le nom
        $nom = '';
        if ( !empty($this->genreInter) ) $nom .= $this->genreInter . ' ';
        if ( !empty($this->genre) ) $nom .= $this->genre . ' ';
        if ( !empty($this->especeInter) ) $nom .= $this->especeInter . ' ';
        if ( !empty($this->espece) ) $nom .= $this->espece . ' ';
        if ( !empty($this->especeAuteur) ) $nom .= $this->especeAuteur . ' ';
        if ( !empty($this->ssp) ) $nom .= $this->ssp . ' ';
        if ( !empty($this->sspNom) ) $nom .= $this->sspNom . ' ';
        if ( !empty($this->sspAuteur) ) $nom .= $this->sspAuteur . ' ';
        if ( !empty($this->cultivar) ) $nom .= $this->cultivar . ' ';
        if ( !empty($this->sexe) ) $nom .= $this->sexe . ' ';
#        $this->nom = $this->genreInter . ' ' . $this->genre . ' ' . $this->especeInter . ' ' . $this->espece . ' ' . $this->especeAuteur . ' ' . $this->ssp . ' ' . $this->sspNom . ' ' . $this->sspAuteur . ' ' . $this->cultivar . ' ' . $this->sexe;
        $this->nom = $nom;
...
#    }
    ...
    {
        $this->origines = $this->complement1 . ' ' . $this->origine1 . ' ' . $this->complement2 . ' ' . $this->origine2 . ' ' . $this->complement3 . ' ' . $this->origine3 . ' ' . $this->complement4 . ' ' . $this->origine4 . ' ' . $this->complement5 . ' ' . $this->origine5;
...
#        return $this->origines;
        return $this->complement1 . ' ' . $this->origine1 . ' ' . $this->complement2 . ' ' . $this->origine2 . ' ' . $this->complement3 . ' ' . $this->origine3 . ' ' . $this->complement4 . ' ' . $this->origine4 . ' ' . $this->complement5 . ' ' . $this->origine5;
    }

    /**
     * Set croissance_noms
     *
     * @param string $croissanceNoms
     * @return BotaniqueTaxon
     */
    public function setCroissanceNoms($croissanceNoms)
    {
        $this->croissance_noms = $croissanceNoms;
     ...
     * @return string
     */
    public function getCroissanceNoms()
    {
#        return $this->croissance_noms;
        $result = "";
        foreach ($this->croissance as $croissance) {
            $result == "" ? $separateur = "" : $separateur = ". ";
            $result .= $separateur . $croissance;
     ...
     * @return BotaniqueTaxon
     */
    public function addCategory(\NTE\BogartBundle\Entity\BotaniqueCategorie $categories)
    {
        $this->categories[] = $categories;
