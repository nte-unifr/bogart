...
#        if( (count($session_data) >= 2) && ($session_data[1] !== $user) && ($session_data[0] > $now->format('Y-m-d H:i:s')) ){
        if( $lock ){
            ...
            $formMapper
                ...
                ->add('geographyteId')
                ->add('inventaire', 'sonata_type_boolean', array('empty_value' => '- - - - - -','required' => false))
                ->add('etiquetteControle', 'sonata_type_boolean', array('empty_value' => '- - - - - -','required' => false))
                ->add('etiquetteType')
                ->add('observations')
                ...
                ->add('commandeGraine')
                ->add('etiquetteSachet', 'sonata_type_boolean', array('empty_value' => '- - - - - -','required' => false))
                ->add('recolteNature1')
                ->add('recolteNature2')
                ->add('recolteNature3')
                ->add('recolteJardin1')
                ->add('recolteJardin2')
                ->add('controle')
                ->add('indexSeminum', 'sonata_type_boolean', array('empty_value' => '- - - - - -','required' => false))
                ->add('indexSeminumNum')
