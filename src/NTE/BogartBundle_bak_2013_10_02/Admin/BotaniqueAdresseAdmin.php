...
class BotaniqueAdresseAdmin extends Admin
{
    ...
    {
        $accession = $this->container->get('doctrine.orm.entity_manager')->getClassMetadata('NTE\BogartBundle\Entity\BotaniqueAdresse');
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $categories = array('Presse' => 'Presse', 'Presse' => 'Presse', 'Surveillance / amis' => 'Surveillance / amis', 'Manifestations' => 'Manifestations', 'Pépinières' => 'Pépinières', 
                            'Paysagistes' => 'Paysagistes', 'Personnel' => 'Personnel', 'Ancien personnel' => 'Ancien personnel', 'Contacts Université' => 'Contacts Université', 'Divers' => 'Divers', );
        
        $formMapper
            ->add('filemakerNum', null, array('read_only' => true))
            ...
            ->add('remarques')
            ->add('ipen')
            ->add('envoiIs', 'sonata_type_boolean', array('empty_value' => '- - - - - -','required' => false))
