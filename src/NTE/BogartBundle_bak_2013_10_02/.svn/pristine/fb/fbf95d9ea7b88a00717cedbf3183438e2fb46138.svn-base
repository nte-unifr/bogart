...
use NTE\BogartBundle\Entity\BotaniqueGenre;
 
class BotaniqueGenreAdmin extends Admin
{
    /**
     * @return array
     */
    ...
    {
        $accession = $this->container->get('doctrine.orm.entity_manager')->getClassMetadata('NTE\BogartBundle\Entity\BotaniqueGenre');
